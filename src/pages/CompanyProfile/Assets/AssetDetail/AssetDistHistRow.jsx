...
const AssetDistHistRow = ({data}) => {
    return (
        <div className="bg-gray-100 py-3 px-2 grid grid-cols-8 border-2">
            <div >
                {
                    data.retruned ? <CiBookmarkCheck size={40} color="#6558F5" />
...
export default AssetDistHistRow;